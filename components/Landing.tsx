...
const TOOL_GROUPS: ToolGroup[] = [
  ...
  },
  {
    ...
    tone: "teal",
    items: [
      { label: "Create an image", href: "/tools/create-image" },
      { label: "Download from a URL", href: "/tools/image-downloader" },
      { label: "Convert and resize", href: "/tools/image-editor" },
  ...
  },
  {
    ...
    tone: "amber",
    items: [
      { label: "Anything to PDF", href: "/tools/file-to-pdf" },
      { label: "Images to one PDF", href: "/tools/images-to-pdf" },
      { label: "PDF to page images", href: "/tools/pdf-to-images" },
